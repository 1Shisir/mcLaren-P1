        ...
        <div className='relative z-10 h-full'>
          <div className='absolute top-12 left-8 max-w-xl space-y-6'>
            <div className='fade-item inline-flex items-center gap-3'>
              ...
              <span className='text-sm uppercase tracking-[0.4em] text-orange-300'>Specification</span>
            </div>
            <h1 className='fade-item text-5xl lg:text-6xl font-extrabold leading-tight text-white drop-shadow-2xl'>Defining technical excellence.</h1>
